                            ...
                            {notifications.length > 0 ?
                                <div className='flex flex-col gap-8'>
                                    ...
                                    {visibleCount < notifications.length &&
                                        <button onClick={() => setVisibleCount(visibleCount + 10)} className='md:w-1/2 w-full h-fit py-2 px-14 text-sm md:text-base flex items-center justify-center text-center rounded-md bg-ash hover:bg-primary cursor-pointer mx-auto'>Show Older Notifications</button>
                                    }
                                </div>
                                :
